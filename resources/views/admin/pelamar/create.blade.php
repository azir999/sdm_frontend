        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email_pelamar" id="email_pelamar" 
                           class="form-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2 px-3">
                </div>

                {{-- md:col-span-2 dihapus agar menjadi satu kolom penuh --}}
                <div>
                    ...
                    <textarea id="alamat_pelamar" name="alamat_pelamar" rows="3" 
                              class="form-textarea mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2 px-3"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="usia" id="usia" min="0"
                           class="form-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2 px-3">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="bidang_ilmu" id="bidang_ilmu" 
                           class="form-input mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2 px-3">
                </div>
                    ...
                    <select id="pilihan_lamaran" name="pilihan_lamaran" 
                        ...
                        <option value="">-Dosen/Karyawan-</option>
                         @foreach($pilihanLamaranOptions ?? [] as $option)
                            <option value="{{ strtolower(str_replace(' ', '_', $option)) }}">{{ $option }}</option>
                        @endforeach
                    </select>
                </div>
