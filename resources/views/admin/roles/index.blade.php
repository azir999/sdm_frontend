...
@section('content')
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="bg-[#1D3F8E] text-white p-4 flex justify-between items-center">
            ...
            <a href="{{ route('admin.roles.create') }}" class="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-3 rounded-md shadow-sm inline-flex items-center text-xs">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="inline-flex items-center space-x-2">
                                <a href="{{ route('admin.roles.edit', $role->id) }}" class="text-blue-600 hover:text-blue-800" title="Edit Role">
                                    <i class="fas fa-edit text-lg"></i>
                                </a>
                                <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus role ini? Role yang sudah digunakan mungkin tidak bisa dihapus.');">
                                    @csrf
                                    @method('DELETE')
